...
//	네이버 로그인 API 등록시 발급받은 Client ID, Client Secret과 Callback URL을 입력한다.
	private final static String CLIENT_ID = "oO6Ejwc9Fb4jj38Ziiwt";
	private final static String CLIENT_SECRET = "7R1N6BLXx3";
	private final static String REDIRECT_URI = "http://localhost:9090/CyCaOn/naverLogin";
